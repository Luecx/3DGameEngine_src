...
import projects.vier_gewinnt_v2.communication.protocol.exceptions.CommandException;
import projects.vier_gewinnt_v2.communication.protocol.exceptions.ArgumentException;
...
public class Command {
    ...
    public void clearValues() {
        for (String key : arguments.keySet()) {
            arguments.get(key).setValues(null);
        }
    }
